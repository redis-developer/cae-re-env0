...
class AccountApiUpdateVcsProviderUserMappingsRequestBody(BaseModel):
    """
    AccountApiUpdateVcsProviderUserMappingsRequestBody
    """ # noqa: E501
    vcs_provider_user_id: StrictStr = Field(alias="vcsProviderUserId")
    organization_id: StrictStr = Field(alias="organizationId")
    __properties: ClassVar[List[str]] = ["vcsProviderUserId", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vcsProviderUserId": obj.get("vcsProviderUserId"),
