...
class AccountApiUpdateVcsProviderUserMappingsRequestPathParams(BaseModel):
    """
    AccountApiUpdateVcsProviderUserMappingsRequestPathParams
    """ # noqa: E501
    mapping_id: StrictStr = Field(alias="mappingId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["mappingId"]
