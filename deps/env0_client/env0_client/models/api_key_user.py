...
class ApiKeyUser(BaseModel):
    ...
    identities: Optional[List[ApiKeyUserIdentity]] = None
    __properties: ClassVar[List[str]] = ["user_id", "username", "created_at", "app_metadata", "name", "nickname", "last_login", "blocked", "identities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identities": [ApiKeyUserIdentity.from_dict(_item) for _item in obj["identities"]] if obj.get("identities") is not None else None
        })
        return _obj
