...
class ApiKeyUserIdentity(BaseModel):
    """
    ApiKeyUserIdentity
    """ # noqa: E501
    user_id: Optional[StrictStr] = None
    profile_data: Optional[ApiKeyUserIdentityProfileData] = Field(default=None, alias="profileData")
    blocked: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["user_id", "profileData", "blocked"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profileData": ApiKeyUserIdentityProfileData.from_dict(obj["profileData"]) if obj.get("profileData") is not None else None,
