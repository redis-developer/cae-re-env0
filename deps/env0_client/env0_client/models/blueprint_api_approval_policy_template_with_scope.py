...
class BlueprintApiApprovalPolicyTemplateWithScope(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    scope: BlueprintApiApprovalPolicyScope
    scope_id: StrictStr = Field(alias="scopeId")
    blueprint: BlueprintApiApprovalPolicyTemplate
    created_at: StrictStr = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "scope", "scopeId", "blueprint", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blueprint": BlueprintApiApprovalPolicyTemplate.from_dict(obj["blueprint"]) if obj.get("blueprint") is not None else None,
