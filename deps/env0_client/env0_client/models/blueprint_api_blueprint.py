...
class BlueprintApiBlueprint(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tokenName", "tokenId", "sshKeys", "githubInstallationId", "bitbucketClientKey", "isBitbucketServer", "isGitLabEnterprise", "isGitHubEnterprise", "isGitLab", "isAzureDevOps", "isHelmRepository", "repository", "revision", "path", "fileName", "helmChartName", "terraformVersion", "opentofuVersion", "terragruntVersion", "terragruntTfBinary", "pulumiVersion", "type", "name", "description", "retry", "runTestsOnPullRequest", "isTerragruntRunAll", "projectIds", "tagPrefix", "id", "author", "createdAt", "updatedAt", "isDeleted", "authorId", "organizationId", "projectId", "isSingleUse"]
