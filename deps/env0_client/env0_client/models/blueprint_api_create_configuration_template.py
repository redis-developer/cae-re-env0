...
class BlueprintApiCreateConfigurationTemplate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "repository", "revision", "path", "organizationId", "tokenName", "tokenId", "githubInstallationId", "bitbucketClientKey", "isBitbucketServer", "isGitLabEnterprise", "isGitHubEnterprise", "isGitLab", "isAzureDevOps"]
