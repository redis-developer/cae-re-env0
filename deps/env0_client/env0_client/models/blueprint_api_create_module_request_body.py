...
class BlueprintApiCreateModuleRequestBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organizationId", "author", "authorId", "createdAt", "updatedAt", "isDeleted", "type", "repository", "description", "tokenId", "tokenName", "githubInstallationId", "bitbucketClientKey", "isGitLab", "isAzureDevOps", "isBitbucketServer", "isGitHubEnterprise", "gitlabProjectId", "path", "runTestsOnPullRequest", "opentofuVersion", "tagPrefix", "moduleName", "moduleProvider", "moduleTestEnabled"]
