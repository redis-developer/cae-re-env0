...
class BlueprintApiEnvironmentDiscoveryResponse(BaseModel):
    """
    BlueprintApiEnvironmentDiscoveryResponse
    """ # noqa: E501
    glob_pattern: StrictStr = Field(alias="globPattern")
    environment_placement: BlueprintApiEnvironmentPlacement = Field(alias="environmentPlacement")
    workspace_naming: BlueprintApiWorkspaceNaming = Field(alias="workspaceNaming")
    ...
    is_single_use: Optional[StrictBool] = Field(default=None, alias="isSingleUse")
    __properties: ClassVar[List[str]] = ["globPattern", "environmentPlacement", "workspaceNaming", "autoDeployByCustomGlob", "rootPath", "repository", "revision", "path", "fileName", "helmChartName", "terraformVersion", "opentofuVersion", "terragruntVersion", "terragruntTfBinary", "pulumiVersion", "type", "gitlabProjectId", "tokenName", "tokenId", "sshKeys", "githubInstallationId", "bitbucketClientKey", "isBitbucketServer", "isGitLabEnterprise", "isGitHubEnterprise", "isGitLab", "isAzureDevOps", "isHelmRepository", "name", "description", "retry", "runTestsOnPullRequest", "isTerragruntRunAll", "projectIds", "tagPrefix", "id", "author", "createdAt", "updatedAt", "isDeleted", "authorId", "organizationId", "projectId", "isSingleUse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "globPattern": obj.get("globPattern"),
            "environmentPlacement": obj.get("environmentPlacement"),
            "workspaceNaming": obj.get("workspaceNaming"),
            ...
            "isSingleUse": obj.get("isSingleUse")
        })
        return _obj
