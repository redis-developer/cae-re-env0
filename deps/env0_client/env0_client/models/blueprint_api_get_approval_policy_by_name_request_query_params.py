...
class BlueprintApiGetApprovalPolicyByNameRequestQueryParams(BaseModel):
    """
    BlueprintApiGetApprovalPolicyByNameRequestQueryParams
    """ # noqa: E501
    name: StrictStr
    organization_id: StrictStr = Field(alias="organizationId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "organizationId"]
