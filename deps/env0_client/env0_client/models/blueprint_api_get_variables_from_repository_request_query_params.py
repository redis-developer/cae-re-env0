...
class BlueprintApiGetVariablesFromRepositoryRequestQueryParams(BaseModel):
    """
    ...
    github_installation_id: Optional[StrictStr] = Field(default=None, alias="githubInstallationId")
    ssh_key_ids: Optional[StrictStr] = Field(default=None, alias="sshKeyIds")
    bitbucket_client_key: Optional[StrictStr] = Field(default=None, alias="bitbucketClientKey")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["revision", "path", "repository", "tokenId", "githubInstallationId", "sshKeyIds", "bitbucketClientKey"]
