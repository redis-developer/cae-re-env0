...
class BlueprintApiModuleRegistryDownloadSourceRequestPathParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organizationId", "moduleName", "providerName", "version"]
