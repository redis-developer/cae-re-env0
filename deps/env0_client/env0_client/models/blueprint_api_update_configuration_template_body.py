...
class BlueprintApiUpdateConfigurationTemplateBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tokenName", "tokenId", "githubInstallationId", "bitbucketClientKey", "isBitbucketServer", "isGitLabEnterprise", "isGitHubEnterprise", "isGitLab", "isAzureDevOps", "name", "repository", "revision", "path"]
