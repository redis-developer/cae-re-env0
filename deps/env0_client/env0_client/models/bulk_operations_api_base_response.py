...
class BulkOperationsApiBaseResponse(BaseModel):
    """
    BulkOperationsApiBaseResponse
    """ # noqa: E501
    data: List[BulkOperationsApiSingleResult]
    organization_id: StrictStr = Field(alias="organizationId")
    __properties: ClassVar[List[str]] = ["data", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BulkOperationsApiSingleResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
