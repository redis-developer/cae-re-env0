...
class BulkOperationsApiBulkDestroyRequestBody(BaseModel):
    """
    ...
    data: BulkOperationsApiBulkDestroyRequestBodyData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BulkOperationsApiBulkDestroyRequestBodyData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
