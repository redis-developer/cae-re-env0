...
class BulkOperationsApiBulkRunTaskRequestBody(BaseModel):
    """
    BulkOperationsApiBulkRunTaskRequestBody
    """ # noqa: E501
    environment_ids: List[StrictStr] = Field(alias="environmentIds")
    organization_id: StrictStr = Field(alias="organizationId")
    data: BulkOperationsApiBulkRunTaskRequestBodyData
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["environmentIds", "organizationId", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environmentIds": obj.get("environmentIds"),
            "organizationId": obj.get("organizationId"),
            "data": BulkOperationsApiBulkRunTaskRequestBodyData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
