...
class ConfigurationApiFindVariablesByScopeOverridingConfigurationProperty(BaseModel):
    ...
    """ # noqa: E501
    overwrites: ConfigurationApiFindVariablesByScopeOverridingConfigurationPropertyOverwrites
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    name: StrictStr
    value: Optional[StrictStr] = None
    id: Optional[Any] = Field(default=None, description="The ID of the configuration property. If provided, will act as an update. Otherwise, a new configuration property will be created.")
    ...
    __properties: ClassVar[List[str]] = ["overwrites", "createdAt", "name", "value", "id", "userId", "isSensitive", "isReadonly", "isRequired", "regex", "scopeId", "scope", "type", "toDelete", "projectId", "organizationId", "schema", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overwrites": ConfigurationApiFindVariablesByScopeOverridingConfigurationPropertyOverwrites.from_dict(obj["overwrites"]) if obj.get("overwrites") is not None else None,
