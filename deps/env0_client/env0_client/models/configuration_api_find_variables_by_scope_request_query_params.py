...
class ConfigurationApiFindVariablesByScopeRequestQueryParams(BaseModel):
    """
    ...
    deployment_log_id: Optional[StrictStr] = Field(default=None, alias="deploymentLogId")
    workflow_blueprint_id: Optional[StrictStr] = Field(default=None, alias="workflowBlueprintId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["organizationId", "setId", "blueprintId", "projectId", "environmentId", "workflowEnvironmentId", "deploymentLogId", "workflowBlueprintId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflowBlueprintId": obj.get("workflowBlueprintId")
        })
