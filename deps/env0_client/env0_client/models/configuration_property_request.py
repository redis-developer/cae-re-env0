...
class ConfigurationPropertyRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "value", "id", "isSensitive", "isReadonly", "isRequired", "regex", "scopeId", "scope", "type", "toDelete", "projectId", "organizationId", "schema", "description"]
