...
class CostApiCostQueryResponseInner(BaseModel):
    """
    CostApiCostQueryResponseInner
    """ # noqa: E501
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    total: CostApiCostQueryResponseInnerTotal
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date", "total", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "total": CostApiCostQueryResponseInnerTotal.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "id": obj.get("id")
        })
        return _obj
