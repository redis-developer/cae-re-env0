...
class CostApiProjectBudgetSummary(BaseModel):
    """
    ...
    renewed_at: datetime = Field(alias="renewedAt")
    __properties: ClassVar[List[str]] = ["projectId", "usage", "amount", "renewedAt"]
