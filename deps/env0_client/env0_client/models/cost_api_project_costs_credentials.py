...
class CostApiProjectCostsCredentials(BaseModel):
    """
    CostApiProjectCostsCredentials
    """ # noqa: E501
    project_id: StrictStr = Field(alias="projectId")
    credentials_id: StrictStr = Field(alias="credentialsId")
    credentials_type: Optional[CredentialType] = Field(default=None, alias="credentialsType")
    __properties: ClassVar[List[str]] = ["projectId", "credentialsId", "credentialsType"]
