...
class DashboardApiQueryActiveEnvironmentsRequestQueryStringParameters(BaseModel):
    """
    DashboardApiQueryActiveEnvironmentsRequestQueryStringParameters
    """ # noqa: E501
    query_name: Optional[Any] = Field(alias="queryName")
    organization_id: StrictStr = Field(alias="organizationId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["queryName", "organizationId"]
