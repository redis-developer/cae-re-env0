...
class DashboardApiQueryBaseResponseStructureApiDTs66446775ApiDTs66296776ApiDTs65996777ApiDTs64616783ApiDTs64216783ApiDTs29610061ApiDTs27110061ApiDTs26910063ApiDTs18610063ApiDTs010064Inner(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['IN_PROGRESS', 'FAILED', 'WAITING_FOR_USER', 'ACTIVE', 'INACTIVE', 'DRIFTED']):
            raise ValueError("must be one of enum values ('IN_PROGRESS', 'FAILED', 'WAITING_FOR_USER', 'ACTIVE', 'INACTIVE', 'DRIFTED')")
        return value
