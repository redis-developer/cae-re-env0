...
class DashboardApiQueryBaseResponseStructureApiDTs77228058ApiDTs77078059ApiDTs76778060ApiDTs75238066ApiDTs74768066ApiDTs29610061ApiDTs27110061ApiDTs26910063ApiDTs18610063ApiDTs010064Inner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "projectName", "projectId", "status", "user", "lastDeploymentDate", "createdAt", "blueprintId", "blueprintName", "isSingleUseBlueprint"]
