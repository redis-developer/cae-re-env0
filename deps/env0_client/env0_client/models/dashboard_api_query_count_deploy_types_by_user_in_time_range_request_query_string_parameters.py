...
class DashboardApiQueryCountDeployTypesByUserInTimeRangeRequestQueryStringParameters(BaseModel):
    """
    DashboardApiQueryCountDeployTypesByUserInTimeRangeRequestQueryStringParameters
    """ # noqa: E501
    start_time: StrictStr = Field(alias="startTime")
    end_time: StrictStr = Field(alias="endTime")
    query_name: Optional[Any] = Field(alias="queryName")
    organization_id: StrictStr = Field(alias="organizationId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["startTime", "endTime", "queryName", "organizationId"]
