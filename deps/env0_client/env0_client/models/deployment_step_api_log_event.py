...
class DeploymentStepApiLogEvent(BaseModel):
    """
    ...
    message: StrictStr
    level: StrictStr
    timestamp: DeploymentStepApiLogEventTimestamp
    __properties: ClassVar[List[str]] = ["eventId", "message", "level", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "level": obj.get("level"),
            "timestamp": DeploymentStepApiLogEventTimestamp.from_dict(obj["timestamp"]) if obj.get("timestamp") is not None else None
        })
        return _obj
