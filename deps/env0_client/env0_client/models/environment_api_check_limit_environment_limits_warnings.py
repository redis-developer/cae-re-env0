...
class EnvironmentApiCheckLimitEnvironmentLimitsWarnings(BaseModel):
    """
    EnvironmentApiCheckLimitEnvironmentLimitsWarnings
    """ # noqa: E501
    total: StrictBool
    user: StrictBool
    __properties: ClassVar[List[str]] = ["total", "user"]
