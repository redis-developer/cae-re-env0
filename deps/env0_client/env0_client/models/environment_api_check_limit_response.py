...
class EnvironmentApiCheckLimitResponse(BaseModel):
    """
    EnvironmentApiCheckLimitResponse
    """ # noqa: E501
    warnings: Optional[EnvironmentApiCheckLimitEnvironmentLimitsWarnings] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    user: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["warnings", "total", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "warnings": EnvironmentApiCheckLimitEnvironmentLimitsWarnings.from_dict(obj["warnings"]) if obj.get("warnings") is not None else None,
            "total": obj.get("total"),
            "user": obj.get("user")
        })
        return _obj
