...
class EnvironmentApiConfigurationPropertyChange(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "value", "id", "isSensitive", "isReadonly", "isRequired", "regex", "type", "toDelete", "projectId", "schema", "description"]
