...
class EnvironmentApiCountByProjectRequestQueryParams(BaseModel):
    """
    EnvironmentApiCountByProjectRequestQueryParams
    """ # noqa: E501
    is_active: Optional[StrictStr] = Field(default=None, alias="isActive")
    status: Optional[EnvironmentApiEnvironmentStatus] = None
    project_id: StrictStr = Field(alias="projectId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["isActive", "status", "projectId"]
