...
class EnvironmentApiDownstreamEnvironment(BaseModel):
    """
    ...
    latest_deployment_log: EnvironmentApiDownstreamEnvironmentLatestDeploymentLog = Field(alias="latestDeploymentLog")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "workspaceName", "projectId", "latestDeploymentLog"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latestDeploymentLog": EnvironmentApiDownstreamEnvironmentLatestDeploymentLog.from_dict(obj["latestDeploymentLog"]) if obj.get("latestDeploymentLog") is not None else None
        })
