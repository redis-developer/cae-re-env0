...
class EnvironmentApiDownstreamEnvironmentLatestDeploymentLog(BaseModel):
    """
    EnvironmentApiDownstreamEnvironmentLatestDeploymentLog
    """ # noqa: E501
    blueprint_name: StrictStr = Field(alias="blueprintName")
    __properties: ClassVar[List[str]] = ["blueprintName"]
