...
class EnvironmentApiEnvironmentLockStatus(BaseModel):
    ...
    updated_by_user: Optional[User] = Field(default=None, alias="updatedByUser")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["reason", "updatedBy", "updatedByUser", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updatedByUser": User.from_dict(obj["updatedByUser"]) if obj.get("updatedByUser") is not None else None,
