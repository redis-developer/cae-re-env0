...
class EnvironmentApiFindDeploymentLogsByEnvironmentIdRequestQueryParams(BaseModel):
    """
    ...
    deployment_types: Optional[EnvironmentApiDeploymentType] = Field(default=None, alias="deploymentTypes")
    statuses: Optional[EnvironmentApiDeploymentLogStatus] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["limit", "offset", "fromDate", "toDate", "deploymentTypes", "statuses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deploymentTypes": obj.get("deploymentTypes"),
