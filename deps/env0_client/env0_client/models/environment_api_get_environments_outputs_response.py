...
class EnvironmentApiGetEnvironmentsOutputsResponse(BaseModel):
    """
    EnvironmentApiGetEnvironmentsOutputsResponse
    """ # noqa: E501
    outputs: List[EnvironmentApiGetEnvironmentsOutputsResponseOutputsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputs": [EnvironmentApiGetEnvironmentsOutputsResponseOutputsInner.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None
        })
