...
class EnvironmentApiGetEnvironmentsOutputsResponseOutputsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "environmentId", "name", "isSensitive", "environmentName"]
