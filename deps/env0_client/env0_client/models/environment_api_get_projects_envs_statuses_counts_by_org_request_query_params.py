...
class EnvironmentApiGetProjectsEnvsStatusesCountsByOrgRequestQueryParams(BaseModel):
    """
    ...
    drift_status: Optional[StrictStr] = Field(default=None, alias="driftStatus")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["organizationId", "status", "isActive", "driftStatus"]
