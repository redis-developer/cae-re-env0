...
class EnvironmentApiWorkflowEnvironmentsWorkflowFile(BaseModel):
    """
    EnvironmentApiWorkflowEnvironmentsWorkflowFile
    """ # noqa: E501
    settings: Optional[WorkflowFileSettings] = None
    environments: Dict[str, EnvironmentApiWorkflowEnvironmentsWorkflowSubEnvironment]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["settings", "environments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "settings": WorkflowFileSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None,
        })
