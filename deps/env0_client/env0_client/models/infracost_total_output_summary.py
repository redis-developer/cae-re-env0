...
class InfracostTotalOutputSummary(BaseModel):
    """
    InfracostTotalOutputSummary
    """ # noqa: E501
    unsupported_resource_counts: Optional[Any] = Field(alias="unsupportedResourceCounts")
    __properties: ClassVar[List[str]] = ["unsupportedResourceCounts"]
