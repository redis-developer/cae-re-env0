...
class ModuleTestingApiTestFileSummary(BaseModel):
    """
    ModuleTestingApiTestFileSummary
    """ # noqa: E501
    passed: Optional[Union[StrictFloat, StrictInt]] = None
    failed: Optional[Union[StrictFloat, StrictInt]] = None
    skipped: Optional[Union[StrictFloat, StrictInt]] = None
    errored: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["passed", "failed", "skipped", "errored"]
