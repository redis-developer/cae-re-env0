...
class NotificationsApiNotificationEndpoint(BaseModel):
    """
    ...
    type: Optional[NotificationEndpointType] = None
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdByUser", "organizationId", "name", "type", "value"]
