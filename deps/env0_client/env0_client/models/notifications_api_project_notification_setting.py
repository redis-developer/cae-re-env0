...
class NotificationsApiProjectNotificationSetting(BaseModel):
    """
    NotificationsApiProjectNotificationSetting
    """ # noqa: E501
    id: Optional[StrictStr] = None
    notification_endpoint_id: StrictStr = Field(alias="notificationEndpointId")
    event_names: List[EventNameType] = Field(alias="eventNames")
    created_by: Optional[StrictStr] = Field(default=None, alias="createdBy")
    created_by_user: Optional[User] = Field(default=None, alias="createdByUser")
    __properties: ClassVar[List[str]] = ["id", "notificationEndpointId", "eventNames", "createdBy", "createdByUser"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "notificationEndpointId": obj.get("notificationEndpointId"),
            "eventNames": obj.get("eventNames"),
