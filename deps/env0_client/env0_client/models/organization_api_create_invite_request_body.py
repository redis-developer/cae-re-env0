...
class OrganizationApiCreateInviteRequestBody(BaseModel):
    """
    OrganizationApiCreateInviteRequestBody
    """ # noqa: E501
    email: StrictStr
    organization_id: StrictStr = Field(alias="organizationId")
    permissions: Optional[OrganizationApiPermissions] = None
    __properties: ClassVar[List[str]] = ["email", "organizationId", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": OrganizationApiPermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None
        })
        return _obj
