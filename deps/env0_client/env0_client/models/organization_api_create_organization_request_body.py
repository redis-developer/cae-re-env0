...
class OrganizationApiCreateOrganizationRequestBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "photoUrl"]

    @field_validator('name')
    def name_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[a-zA-Z0-9][a-zA-Z0-9-_ ]{0,49}$", value):
            raise ValueError(r"must validate the regular expression /^[a-zA-Z0-9][a-zA-Z0-9-_ ]{0,49}$/")
        return value
