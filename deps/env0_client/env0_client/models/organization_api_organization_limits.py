...
class OrganizationApiOrganizationLimits(BaseModel):
    """
    OrganizationApiOrganizationLimits
    """ # noqa: E501
    environments: OrganizationApiOrganizationLimitsEnvironments
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environments": OrganizationApiOrganizationLimitsEnvironments.from_dict(obj["environments"]) if obj.get("environments") is not None else None
        })
