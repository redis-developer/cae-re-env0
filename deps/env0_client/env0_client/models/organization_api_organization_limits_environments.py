...
class OrganizationApiOrganizationLimitsEnvironments(BaseModel):
    """
    OrganizationApiOrganizationLimitsEnvironments
    """ # noqa: E501
    limit: Optional[Union[StrictFloat, StrictInt]] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    limit_reached: StrictBool = Field(alias="limitReached")
    __properties: ClassVar[List[str]] = ["limit", "amount", "limitReached"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limitReached": obj.get("limitReached")
        })
        return _obj
