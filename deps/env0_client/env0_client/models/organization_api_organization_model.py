...
class OrganizationApiOrganizationModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "maxTtl", "defaultTtl", "doNotReportSkippedStatusChecks", "doNotConsiderMergeCommitsForPrPlans", "enableOidc", "description", "photoUrl", "createdBy", "createdAt", "updatedAt", "mode", "trialEnd", "enforcePrCommenterPermissions", "projectCustomFlowsPolicy"]
