...
class OrganizationUserUser(BaseModel):
    ...
    app_metadata: Optional[OrganizationUserUserAppMetadata] = None
    __properties: ClassVar[List[str]] = ["user_id", "email", "name", "last_login", "picture", "given_name", "family_name", "app_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "app_metadata": OrganizationUserUserAppMetadata.from_dict(obj["app_metadata"]) if obj.get("app_metadata") is not None else None
        })
        return _obj
