...
class ProjectApiMoveProjectRequestBody(BaseModel):
    """
    ProjectApiMoveProjectRequestBody
    """ # noqa: E501
    target_project_id: Optional[StrictStr] = Field(alias="targetProjectId")
    __properties: ClassVar[List[str]] = ["targetProjectId"]
