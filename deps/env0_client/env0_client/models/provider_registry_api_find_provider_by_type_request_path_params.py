...
class ProviderRegistryApiFindProviderByTypeRequestPathParams(BaseModel):
    """
    ProviderRegistryApiFindProviderByTypeRequestPathParams
    """ # noqa: E501
    namespace: StrictStr
    type: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["namespace", "type"]
