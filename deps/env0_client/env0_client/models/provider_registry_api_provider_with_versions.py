...
class ProviderRegistryApiProviderWithVersions(BaseModel):
    """
    ProviderRegistryApiProviderWithVersions
    """ # noqa: E501
    versions: List[ProviderRegistryApiVersion]
    ...
    __properties: ClassVar[List[str]] = ["versions", "id", "type", "organizationId", "description", "createdBy", "createdByUser"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [ProviderRegistryApiVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None,
            "id": obj.get("id"),
            "type": obj.get("type"),
