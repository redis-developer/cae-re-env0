...
class ProviderRegistryApiTerraformTypesProviderVersions(BaseModel):
    """
    ProviderRegistryApiTerraformTypesProviderVersions
    """ # noqa: E501
    versions: List[ProviderRegistryApiTerraformTypesVersion]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [ProviderRegistryApiTerraformTypesVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
