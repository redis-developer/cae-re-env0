...
class ProviderRegistryApiTerraformTypesVersion(BaseModel):
    """
    ProviderRegistryApiTerraformTypesVersion
    """ # noqa: E501
    version: StrictStr
    platforms: List[ProviderRegistryApiTerraformTypesPlatform]
    __properties: ClassVar[List[str]] = ["version", "platforms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "platforms": [ProviderRegistryApiTerraformTypesPlatform.from_dict(_item) for _item in obj["platforms"]] if obj.get("platforms") is not None else None
        })
        return _obj
