...
class ProviderRegistryApiVersion(BaseModel):
    """
    ...
    version: StrictStr
    gpg_key_id: StrictStr = Field(alias="gpgKeyId")
    platform: StrictStr
    shasum: Optional[StrictStr] = None
    is_archived: Optional[StrictBool] = Field(default=None, alias="isArchived")
    __properties: ClassVar[List[str]] = ["id", "providerId", "version", "gpgKeyId", "platform", "shasum", "isArchived"]
