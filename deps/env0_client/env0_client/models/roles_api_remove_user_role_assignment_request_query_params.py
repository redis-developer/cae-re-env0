...
class RolesApiRemoveUserRoleAssignmentRequestQueryParams(BaseModel):
    """
    RolesApiRemoveUserRoleAssignmentRequestQueryParams
    """ # noqa: E501
    environment_id: StrictStr = Field(alias="environmentId")
    user_id: StrictStr = Field(alias="userId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["environmentId", "userId"]
