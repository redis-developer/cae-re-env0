...
class RolesApiUserRoleAssignment(BaseModel):
    """
    RolesApiUserRoleAssignment
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    user: Optional[User] = None
    role: Optional[RolesApiRBACPermissionRole] = None
    organization_id: Optional[StrictStr] = Field(default=None, alias="organizationId")
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    environment_id: Optional[StrictStr] = Field(default=None, alias="environmentId")
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["userId", "user", "role", "organizationId", "projectId", "environmentId", "id"]
