...
class SchedulingApiScheduledAction(BaseModel):
    """
    ...
    enabled: StrictBool
    __properties: ClassVar[List[str]] = ["id", "createdAt", "createdBy", "updatedAt", "environmentId", "projectId", "organizationId", "cron", "nextSchedule", "enabled"]
