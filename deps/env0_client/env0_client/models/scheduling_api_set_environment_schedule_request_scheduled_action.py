...
class SchedulingApiSetEnvironmentScheduleRequestScheduledAction(BaseModel):
    """
    SchedulingApiSetEnvironmentScheduleRequestScheduledAction
    """ # noqa: E501
    cron: StrictStr
    enabled: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["cron", "enabled"]
