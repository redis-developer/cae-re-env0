...
class TeamApiDeprecatedUpdateAssignmentsRequestBody(BaseModel):
    """
    TeamApiDeprecatedUpdateAssignmentsRequestBody
    """ # noqa: E501
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    organization_id: Optional[StrictStr] = Field(default=None, alias="organizationId")
    assignments: List[TeamApiDeprecatedUpdateAssignmentsTeamRoleTuple]
    __properties: ClassVar[List[str]] = ["projectId", "organizationId", "assignments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignments": [TeamApiDeprecatedUpdateAssignmentsTeamRoleTuple.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None
        })
        return _obj
