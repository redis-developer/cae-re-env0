...
class WorkflowSubEnvironment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "templateName", "templateId", "templateType", "revision", "workspace", "needs", "terragruntWorkingDirectory", "disabled"]
