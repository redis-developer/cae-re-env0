...
class WorkflowSubEnvironmentRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["revision", "workspaceName", "k8sNamespace", "terragruntWorkingDirectory", "configurationChanges", "isRemoteBackend"]
