...
class TestBlueprintApiBlueprintUserFields(unittest.TestCase):
    """BlueprintApiBlueprintUserFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlueprintApiBlueprintUserFields:
        """Test BlueprintApiBlueprintUserFields
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlueprintApiBlueprintUserFields`
        """
        model = BlueprintApiBlueprintUserFields()
        if include_optional:
            return BlueprintApiBlueprintUserFields(
                name = '',
                description = '',
    ...
    def testBlueprintApiBlueprintUserFields(self):
        """Test BlueprintApiBlueprintUserFields"""
