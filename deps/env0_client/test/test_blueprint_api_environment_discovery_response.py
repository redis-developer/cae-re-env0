...
class TestBlueprintApiEnvironmentDiscoveryResponse(unittest.TestCase):
    """BlueprintApiEnvironmentDiscoveryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlueprintApiEnvironmentDiscoveryResponse:
        """Test BlueprintApiEnvironmentDiscoveryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlueprintApiEnvironmentDiscoveryResponse`
        """
        model = BlueprintApiEnvironmentDiscoveryResponse()
        if include_optional:
            return BlueprintApiEnvironmentDiscoveryResponse(
                glob_pattern = '',
    ...
    def testBlueprintApiEnvironmentDiscoveryResponse(self):
        """Test BlueprintApiEnvironmentDiscoveryResponse"""
