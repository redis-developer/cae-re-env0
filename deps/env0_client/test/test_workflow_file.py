...
class TestWorkflowFile(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkflowFile:
        """Test WorkflowFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowFile`
        """
        model = WorkflowFile()
        if include_optional:
            return WorkflowFile(
                environments = {
                    'key' : env0_client.models.workflow_sub_environment.WorkflowSubEnvironment(
                        name = '', 
                        template_name = '', 
                        template_id = '', 
